...
\providecommand{\versn}{} % Version; like, web or pdf or journal submission {Web}
\ifthenelse{\boolean{ifWeb}}{    % {Web} 
...
\renewcommand{\forcedate}{November 9, 2020}
...
\ifthenelse{\boolean{ifWeb}}{}{\thanks{\thankstext}} % {Web}

\titlepagefinish

% \begin{Web}
%   If web version, then just incorporate thanks at beginning of text {Web} 
%   instead of in frontmatter {Web} 
\ifthenelse{\boolean{ifWeb}}{\medskip \noindent {\tiny % {Web} 
    \thankstext \medskip \medskip \medskip % {Web} 
  }}{\pagebreak  % {Web} 
} % \end{Web}
