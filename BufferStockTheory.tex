\input{./econtexRoot}\input{\econtexPaths} % Set paths for root and various resources
...
\usepackage{\LaTeXGenerated/BufferStockTheory}% Styling for whole paper (and subfiles)
...
\bibliography{\LaTeXGenerated/BufferStockTheory,economics}
