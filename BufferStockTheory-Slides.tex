\input{./econtexRoot}\input{\econtexPaths}\documentclass[pdflatex]{beamer}\providecommand{\texname}{BufferStockTheory-Slides}% Indicate the keyname for the bibtex entry corresponding to this document
\newif\ifdvi\dvifalse
...
\bibliography{economics,\LaTeXGenerated/\texname}
