...
\begin{verbatimwrite}{\LaTeXFiles/\figName}
...
\begin{verbatimwrite}{\LaTeXFiles/RelatePFGICFHWCRICPFFVAC}
...
\end{figure}
\end{verbatimwrite}
\input{\LaTeXFiles/RelatePFGICFHWCRICPFFVAC}
...
\begin{verbatimwrite}{\LaTeXFiles/Inequalities}
\tikzset{node distance=5cm, auto, >=latex}
\begin{figure}[h]
