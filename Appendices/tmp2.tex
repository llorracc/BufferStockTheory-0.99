...
%\begin{verbatimwrite}{\LaTeXFiles/ApndxSolnMethTermFunc.tex}
\section{The Terminal/Limiting Consumption Function}\label{sec:ApndxConditDiagrams}
...
%\end{verbatimwrite}%\input {\LaTeXFiles/ApndxSolnMethTermFunc.tex}
