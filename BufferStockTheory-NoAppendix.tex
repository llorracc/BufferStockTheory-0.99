...
\renewcommand{\forcedate}{October 27, 2020}
\date{\forcedate}
...
\cite{blanchardFinite}'s innovation was useful not only for the insight it provided into key mechanisms but also because the prevailing alternative, the Life Cycle model of \cite{modiglianiWealth}, was unwieldy and difficult to use with the available computational technologies when Blanchard was writing.  Leaving aside its value in building qualitative understanding of finite horizons, Blanchard's analytical solution has little application today; all quantitatively serious modeling now incorporates uncertainty, constraints, and other features that rule out analytical solutions anyway.  And computational models can can easily handle assumptions more realistic than Blanchard's about the disposition of assets at death.
