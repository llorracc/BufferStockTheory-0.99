...
\begin{document}\providecommand{\econtexBib}{\econtexRoot/Resources/texmf-local/bibtex/bib/economics}\renewcommand{\rootFromOut}{.}

\providecommand{\versn}{} % Version; like, web or pdf or journal submission
\ifthenelse{\boolean{ifWeb}}{
  \renewcommand{\ushort}{\underline}\renewcommand{\versn}{Web}
  \renewcommand{\rootFromOut}{.}\renewcommand{\TableDir}{.}
}{} % ushort does not work in tex4ht
