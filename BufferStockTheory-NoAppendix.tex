...
\externaldocument{\econtexRoot/BufferStockTheory} % Get xrefs -- esp to appendix -- from main file; only works properly if main file has already been compiled; 
...
\begin{verbatimwrite}{\rootFromOut/\EqDir/supfn}
...
\begin{verbatimwrite}{\rootFromOut/\EqDir/DBCparts}
  \begin{align}
...
\begin{verbatimwrite}{\rootFromOut/\EqDir/tShkDef}
  \begin{equation}
    \tShkAll _{t+n}=
    \begin{cases}
...
\begin{verbatimwrite}{\rootFromOut/\EqDir/PFGIC}
\begin{align}
...
\begin{verbatimwrite}{\rootFromOut/\EqDir/PGroAdj}
  \begin{align}
...
\begin{verbatimwrite}{\rootFromOut/\EqDir/PatPGroAdj}
  \begin{align}
...
\begin{verbatimwrite}{\rootFromOut/\EqDir/GIC}
  \begin{align}
...
\begin{verbatimwrite}{\rootFromOut/\EqDir/FVAC}
  \begin{align}
...
\begin{comment}
  ...
  \begin{verbatimwrite}{\rootFromOut/\EqDir/FVACAlt}
    \begin{align}
